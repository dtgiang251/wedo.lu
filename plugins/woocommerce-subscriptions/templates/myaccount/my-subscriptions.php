...
<div class="woocommerce_account_subscriptions">
	...
	<?php else : ?>
		...
		<p class="no_subscriptions">
			...
			printf( esc_html__( "Vous n'avez pas d'abonnements actifs. Trouvez votre premier abonnement dans la rubrique %sstore%s.", 'woocommerce-subscriptions' ), '<a href="' . esc_url( apply_filters( 'woocommerce_subscriptions_message_store_url', get_permalink( wc_get_page_id( 'shop' ) ) ) ) . '">', '</a>' );
			?>
		</p>
