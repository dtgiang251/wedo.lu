 ...
 <div class="full-width">
   ...
   if ( ! empty( $countries ) || ! is_wp_error( $countries ) ){
      	...
      	foreach ( $countries as $country ) {
        	$country_select .= '<option value="'.$country->term_id.'" '. selected($country->term_id, $slug, false) .' >' . $country->name . '</option>';
      	}
      ...
      $skill_list.='</select>';
		...
		<?php $i++; } ?>
                            ...
                            <div class="col-xl-9 col-lg-8 col-sm-7 col" id="main">
                                ...
                                $skills = get_field('skills',$cat);
									...
									<li class="full-width">
										...
										<?php _e('Select All / Unselect All', 'wedo'); ?>
									</li>
								...
								<input type="checkbox"  <?php if( in_array($skill->term_id, $list_ids) ){?> checked="checked" <?php } ?> name="skill" value="<?php echo $skill->term_id;?>">
                        ...
                        <div class="row ">
                            <div class="col-sm-12">
								...
								<?php if(ICL_LANGUAGE_CODE=='en'){
									...
									<div id="sucssess-message" class="modal fade" tabindex="-1" role="dialog">
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  <div class="modal-body">
											<p><?php echo __('Your Profile has been updated', 'boxtheme'); ?></p>
										  </div>
										  <div class="modal-footer">
											<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo __('Close', 'boxtheme'); ?></button>
										  </div>
										</div><!-- /.modal-content -->
									  </div><!-- /.modal-dialog -->
									</div><!-- /.modal -->
			...
			<style type="text/css">
				#sucssess-message .modal-dialog {
					margin-top: 200px;
				}
				.skill-list li.full-width {
					width: 100%;
				}
				.switch input {
				  opacity: 0;
			...
			<script type="text/javascript">
				jQuery(document).ready(function($){
					$('.switch input[type="checkbox"]').change(function(){
						if( $(this).is(':checked') ) {
							$(this).parents('ul').find('input[name="skill"]').attr('checked', true);
						}
						else {
							$(this).parents('ul').find('input[name="skill"]').attr('checked', false);
						}
					});
				});
			</script>
