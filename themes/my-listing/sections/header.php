<?php
	...
	$header_classes[] = sprintf( 'cts-%s-font', c27()->get_setting( 'header_menu_font_size', 'default' ) );
	$header_classes[] = sprintf( 'cts-font-weight-%s', c27()->get_setting( 'header_menu_font_weight', 'normal' ) );
			...
			<div class="header-right">
				<?php if (is_user_logged_in()): $current_user = wp_get_current_user(); ?>
					<div class="user-area">
						...
						<?php // @todo: header cart ?>
						<?php if ( class_exists( 'WC_Widget_Cart' ) && false ): ?>
							<div class="user-cart-dropdown">
								<a class="view-cart-contents" href="#" type="button" id="user-cart-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" title="<?php _e( 'View your shopping cart', 'my-listing' ); ?>">
									<span class="icon-shopping-basket-2"></span>
									<i class="header-cart-counter"><?php echo WC()->cart->get_cart_contents_count() ?></i>
								</a>
								<div class="dropdown-menu" aria-labelledby="user-cart-menu">
				...
				<?php if (c27()->get_setting('header_call_to_action_label') && c27()->get_setting('header_call_to_action_links_to') && $data['show_call_to_action']): ?>
					...
					<div class="language-selector">
							<span><img src="https://devis.wedo.lu/wp-content/themes/wpfreelance-child/header-assets/france.png"></span>
                                           </div>
