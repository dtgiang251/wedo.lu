...
<?php else: ?>
	...
	<fieldset class="fieldset-login_required">
		...
		<p>
			<a href="#" data-toggle="modal" data-target="#sign-in-modal" class="buttons button-5"><?php _e( 'Sign in', 'my-listing' ) ?></a>
			<?php if (get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes'): ?>
				<span><?php _e( 'or', 'my-listing' ) ?></span>
				<a href="#" data-toggle="modal" data-target="#sign-up-modal" class="buttons button-5"><?php _e( 'Register', 'my-listing' ) ?></a>
			<?php endif ?>
		</p>
	</fieldset>
