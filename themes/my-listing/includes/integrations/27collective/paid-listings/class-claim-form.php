...
class Claim_Form extends \WP_Job_Manager_Form {
	...
	public function set_page_template( $template ) {
		...
		$page_id = apply_filters( 'wpml_object_id', 11170, 'page' );
	...
	public function claim_package_view() {
		...
		?>
		 <div id="pagehead">
         <img class="pagehead-image" src="<?php echo get_stylesheet_directory_uri();?>/assets/images/pricing-banner.png" alt="image">
          <div class="container vh-center">
          <h2><?php _e( 'Pricing', 'my-listing' ) ?></h2>
        </div>
       </div>
    ...
    <div class="container">
        ...
        <div class="pricing-package">
            <h2><?php _e( 'Choose a Package', 'my-listing' ) ?></h2> 
		...
		<?php /* <section class="i-section c27-packages">
			<div class="container">
