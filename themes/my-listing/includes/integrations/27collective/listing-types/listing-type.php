...
class ListingType {
	...
	public function get_ordering_options() {
		$defaults = [
			[
				'label' => _x( 'Latest', 'Explore listings: Order by listing date', 'wedo-listing' ),
				'key' => 'latest',
				'clauses' => [[
					'orderby' => 'date',
					'order' => 'DESC',
			...
			[
				'label' => _x( 'Top rated', 'Explore listings: Order by rating value', 'wedo-listing' ),
				'key' => 'top-rated',
				'clauses' => [[
			...
			[
				'label' => _x( 'Random', 'Explore listings: Order randomly', 'wedo-listing' ),
				'key' => 'random',
				'clauses' => [[
					'orderby' => 'rand',
					'order' => 'DESC',
