...
class Conditions {
	...
	public function passes() {
		...
		foreach ( $this->conditions as $conditionGroup ) {
			...
			$package_id = isset( $package_id ) ? apply_filters( 'wpml_object_id', $package_id, 'product' ) : 0;
			$this->package_id = isset( $this->package_id ) ? apply_filters( 'wpml_object_id', $this->package_id, 'product' ) : 0;
