		...
		<div class="listing-regions-tab tab-pabe fade c27-explore-regions" :class="state.activeTab == 'regions' ? 'in active' : ''">
			<?php if ( $explore->active_region ): ?>
				<div class="searching-for">
					...
					<?php printf( '<p class="searching-for-text">' . __( 'Searching for listings in %s', 'my-listing' ) . '</p>', '</p><h1 class="filter-label">' . $explore->active_region->get_name() . '</h1><p>' ) ?>
				</div>
			<?php endif ?>
		</div>
		...
		<div class="listing-tags-tab tab-pabe fade c27-explore-tags" :class="state.activeTab == 'tags' ? 'in active' : ''">
			<?php if ( $explore->active_tag ): ?>
				<div class="searching-for">
					...
					<?php printf( '<p class="searching-for-text">' . __( 'Searching listings for %s', 'my-listing' ) . '</p>', '</p><h1 class="filter-label">' . $explore->active_tag->get_name() . '</h1><p>' ) ?>
				</div>
			<?php endif ?>
		</div>
	</div>
