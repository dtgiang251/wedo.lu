...
$project_group_id = $acf->project_group_id;
                ...
                if($fields->have_posts()){ ?>
                    <select class="form-control auto-save" level ="1" name="project_group_id" >
                        ...
                        while($fields->have_posts()){
                            $fields->the_post();
                            global $post; ?>
                            <option value="<?php echo $post->ID;?>" <?php selected( $acf->project_group_id,$post->ID);?>><?php the_title();?></option>
                            <?php
                    ...
                    ?>
                    There is not any fields yet.<br />
                    Go to this <a target="_blank" href="<?php echo $link ;?>"> url </a> to add new group field <?php
