				...
				<div class="form-group row">
					...
					<div class="col-md-9">
						<select class="form-control auto-save" name="type" id="exampleSelect2"  level="1">
							<option value="fix" <?php selected( $commision->type, 'fix' ); ?> > <?php _e('Fix number','boxtheme');?></option>
							<option value="percent" <?php selected( $commision->type, 'percent' ); ?> ><?php _e('Percent','boxtheme');?></option>
						</select>
					</div>
				</div>
				<div class="form-group row">
...
<div id="opt_credit" class="main-group">
   	...
   	<div class="sub-item" id="opt_credit">
		<form >
			<div class="form-group row">
				...
				<div class="col-md-9"><input class="form-control auto-save"  level="0"  value="<?php echo $opt_credit->number_free_credit;?>" name = "number_free_credit" id="number_free_credit"></div>
			</div>
		</form>
	</div>
</div>
