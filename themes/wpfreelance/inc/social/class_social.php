	...
	if( $gg_activate || $fb_activate ){ ?>
	 	<div class="form-row">
            <div class="hr-or"><center>or</center></div>
		        ...
		        <a href='#' class="btn btn-default twitter hide"> <i class="fa fa-twitter modal-icons"></i> <span class="hidden-xs">Sign In with </span>Twitter </a>
		        <a href='#' class="btn btn-default linkedin hide"> <i class="fa fa-linkedin modal-icons"></i><span class="hidden-xs"> Sign In with </span>Linkedin </a>
		 	</div>
     	</div>
	<?php } ?>
<?php } ?>