...
<?php if ($data['template'] == 'explore-1' || $data['template'] == 'explore-2'): ?>
			...
			<div class="finder-listings">
				<div class="fl-head">
					...
					<div class="col-xs-4 text-center">
						<h1 class="listing-results"><span href="#" class="fl-results-no text-left" :style="state.activeTab == 'search-form' || state.activeTab == 'listing-types' ? '' : 'text-align: left;'">
...
<?php if ($data['template'] == 'explore-no-map'): ?>
	...
	<div id="c27-explore-listings">
		<div class="finder-container fc-type-2">
			...
			<div class="finder-search collapse" id="finderSearch">
				<div class="finder-title col-md-12">
					<p class="case27-primary-text"><?php echo esc_html( $data['title'] ) ?></p>
					<p><?php echo esc_html( $data['subtitle'] ) ?></p>
				</div>
				<div class="finder-tabs-wrapper">
					<?php c27()->get_partial('advanced-search-form', [
			...
			<div class="container">
				<div class="fl-head row reveal">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<h1 class="listing-results"><span class="fl-results-no" :style="state.activeTab == 'search-form' || state.activeTab == 'listing-types' ? '' : 'text-align: right;'">
							<i class="mi remove_red_eye" v-show="state.activeTab != 'search-form' && state.activeTab != 'listing-types'"></i>
							<span></span>
						</span></h1>
					</div>
...
<?php if (!$data['template'] ||  $data['template'] == 'new-explore-no-map'): ?>
	<?php $data['listing-wrap'] = 'new-listing'; ?>
	<div id="c27-explore-listings">
		<div class="finder-container fc-type-2">
			<div class="mobile-explore-head">
				<a type="button" class="toggle-mobile-search" data-toggle="collapse" data-target="#finderSearch"><i class="material-icons sm-icon">sort</i><?php _e( 'Search Filters', 'my-listing' ) ?></a>
...
<script type="text/javascript">
	<?php 
		foreach( $GLOBALS['c27-facets-vue-object'] as $key=>$args ) {
			$GLOBALS['c27-facets-vue-object'][$key]['lang'] = apply_filters( 'wpml_current_language', NULL );
		}
	?>
