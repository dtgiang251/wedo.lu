...
<div class="woocommerce_account_subscriptions">
	...
	<?php else : ?>
		...
		<p class="no_subscriptions">
			...
			printf( esc_html__( "You do not have active subscriptions. Find your first subscription in the section %sstore%s.", 'woocommerce-subscriptions' ), '<a href="' . esc_url( apply_filters( 'woocommerce_subscriptions_message_store_url', get_permalink( wc_get_page_id( 'shop' ) ) ) ) . '">', '</a>' );
			?>
		</p>
