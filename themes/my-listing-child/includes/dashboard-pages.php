...
class DashboardPages {
	...
	public function new_menu_items($items)
	{
		...
		$items['ajouter-votre-annonce/?listing_type=offre-demploi&new=1'] = "Ajouter une offre d'emploi";
		$items['ajouter-votre-annonce/?listing_type=promotions&new=1'] = "Ajouter une promotion";
		$items['ajouter-votre-annonce/?listing_type=event&new=1'] = "Ajouter un événement";

		$items['reservation'] = 'Réservations';
		$items['wedo-websites'] = 'Website Builder';
